...
public class Belongings implements Iterable<Item> {
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		if (ring2() != null)        ring2().activate( owner );
	...
	public void uncurseEquipped() {
		ScrollOfRemoveCurse.uncurse( owner, armor(), weapon(), artifact(), artifact2(), misc(), ring(), ring2(), secondWep());
	}
	...
	private class ItemIterator implements Iterator<Item> {
		...
		private Item[] equipped = {weapon, armor, artifact, artifact2, misc, ring, ring2, secondWep};
		...
		public void remove() {
			...
			case 5:
				...
				break;
			case 6:
				equipped[6] = ring2 = null;
				break;
			case 7:
				equipped[7] = secondWep = null;
				break;
			default:
